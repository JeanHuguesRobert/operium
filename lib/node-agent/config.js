...
export function loadOnaConfig(env = process.env) {
  ...
  return {
    ...
    // Tailscale-trust control room may opt into unauthenticated read access.
    // Keep this independent from public health and disabled unless explicitly enabled.
    meshOpenRead: parseBooleanEnv(env.ONA_MESH_OPEN_READ, false),
